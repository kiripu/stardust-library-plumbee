...
import idv.cjcat.stardustextended.common.xml.XMLBuilder;
	 ...
	 */
	public class ImpulseClockAdvanced extends Clock
    {
		...
		public function ImpulseClockAdvanced(_impulseInterval : Random = null,
		...
		override public function parseXML(xml:XML, builder:XMLBuilder = null):void
        {
            ...
            impulseInterval = builder.getElementByName(xml.@impulseInterval) as Random;
            impulseLength = builder.getElementByName(xml.@impulseLength) as Random;
