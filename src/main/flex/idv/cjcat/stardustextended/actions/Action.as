...
public class Action extends StardustElement
{
    ...
    {
        eventDispatcher.dispatchEvent(new StardustActionEvent(StardustActionEvent.ADD, this));
    }

    public function dispatchRemoveEvent() : void
    {
        eventDispatcher.dispatchEvent(new StardustActionEvent(StardustActionEvent.REMOVE, this));
    }
    ...
    {
        _priority = value;
        eventDispatcher.dispatchEvent(new StardustActionEvent(StardustActionEvent.PRIORITY_CHANGE, this));
    }
